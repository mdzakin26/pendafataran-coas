            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('pendaftaran.store') }}" enctype="multipart/form-data">
                        ...
                        {{-- Mata Kuliah --}}
                        <div class="mt-6">
                            <x-input-label for="matakuliah_id" :value="__('Pilih Mata Kuliah')" />
                        ...
                        <div class="mt-6">
                            ...
                            <input id="dokumen_cv" type="file" name="dokumen_cv"
                                class="block mt-1 w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 
