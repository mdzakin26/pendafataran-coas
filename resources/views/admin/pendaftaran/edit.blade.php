{{-- resources/views/admin/pendaftaran/edit.blade.php --}}
<x-app-layout>
    <div class="py-12">
                    ...
                    <form method="POST" action="{{ route('admin.pendaftaran.update', $pendaftaran->id) }}">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea id="alamat" name="alamat"
                                    class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300
                                           ...
                                           focus:ring-indigo-500 dark:focus:ring-indigo-600
                                           rounded-md shadow-sm"
                                    rows="3">{{ old('alamat', $pendaftaran->alamat) }}</textarea>
                            ...
                            <div>
                                ...
                                <x-text-input id="no_telepon" class="block mt-1 w-full"
                                    type="text"
                                    name="no_telepon"
                                    :value="old('no_telepon', $pendaftaran->user->no_telepon)"
                                    disabled />
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                    Nomor telepon diambil dari data user dan tidak bisa diubah di sini.
                                </p>
                            </div>
                        </div>
